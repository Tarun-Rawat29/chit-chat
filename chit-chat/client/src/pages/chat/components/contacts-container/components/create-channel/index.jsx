    ...
    <>
        ...
        <Dialog open={ newChannelModal } onOpenChange={ setNewChannelModal }>
            <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                ...
                <div>
                    <MultipleSelector 
                    className="rounded bg-[#8417ff]/5 hover:bg-purple-900 transition-all border border-[#8417ff] duration-300 py-2 text-[#C5C5D8E6]"
                ...
                <div>
                    <Button 
                        className="w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300 rounded h-10"
