            ...
            <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                ...
                {searchedContacts.length > 0 && 
                    ...
                    <div className="flex flex-col gap-5">
                        {
                            searchedContacts.map(contact => <div key={contact._id} className="flex items-center cursor-pointer gap-3" onClick={() => selectNewContact(contact)}>
                ...
                {
                    searchedContacts.length<=0 && (
                        <div className="flex-1 md:flex flex-col mt-2 justify-center items-center duration-1000 transition-all">
                            <Lottie
